...
export default class Part8WO extends Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
      return(
        <ScrollView style={styles.container}>
            {/* display */}
            <Text style={{ fontWeight: 'bold', fontSize: 16, color: 'black', textAlign: 'center', marginBottom: 20 }}>Cost Details</Text>
            <Form
            ...
            />
            <TouchableHighlight style={styles.button} onPress={this.props.onPress.bind(this, 8)} underlayColor='#99d9f4'>
                <Text style={styles.buttonText}>Next</Text>
            </TouchableHighlight>
            <TouchableHighlight style={[styles.button, {backgroundColor:'#636e70' }]}  onPress={this.props.onBack.bind(this,6)} underlayColor='#99d9f4'>
