...
export default class Part3WO extends Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
      return(
        <ScrollView style={styles.container}>
            {/* display */}
            <Text style={{ fontWeight: 'bold', fontSize: 16, color: 'black', textAlign: 'center', marginBottom: 20 }}>Wo Receipt and Classification</Text>
            <Form
            ...
            />
            <TouchableHighlight style={styles.button} onPress={this.props.onPress.bind(this, 3)} underlayColor='#99d9f4'>
