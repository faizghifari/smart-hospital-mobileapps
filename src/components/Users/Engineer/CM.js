...
import Wo from './../../Users/Engineer/WorkOrder'
    ...
    if (this.state.selectState == 0) {
      var main = (
        <ScrollView style={{ flexGrow: 1, marginTop: 40 }}>
          <View style={{
            ...
            <View style={{ marginLeft: 20 }}>
              ...
              <View style={{ flexDirection: 'row', marginTop: 10, alignItems: 'center' }}>
                <Image style={{ width: 100, height: 100 }} source={require('./../../../images/avatar/engA.jpg')} />
          ...
          <TouchableOpacity style={styles.button} onPress={(value) => this.setState({ selectState: 1 })} >
