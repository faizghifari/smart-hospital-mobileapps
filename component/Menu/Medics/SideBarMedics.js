...
export default class SideBarMedics extends Component {
    constructor(props) {
        super(props);
        this.state = {
            theState: 0
              ...
              <View style={{flex:1,flexDirection:'column'}}>
                <View style={{ flex: 0.30, justifyContent: 'center' }} >
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginTop: 40 }}>
                      <Text style={{ color: "white", marginTop: 20,fontWeight:'bold',fontSize:16 }}>Dr. OZ</Text>
                      <Text style={{ color: "white", fontSize:13 }}>Doctor</Text>
                ...
                <View style={{ flex: 0.70,flexDirection:'row' }}>
                  <View style={{flex:0.9,justifyContent:'center',flexDirection:'column'}}>
                    ...
                    <TouchableOpacity style={[styles.button,{borderColor:'#a29bfe'}]} onPress={this.props.changeMenu.bind(this, 1)}>
                      <Icon style={styles.iconStyle} family="FontAwesome" name="file" /><Text style={styles.buttonText}> Issue Report</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.button,{borderColor:'#48dbfb'}]} onPress={this.props.changeMenu.bind(this, 2)}>
                      <Icon style={styles.iconStyle} family="FontAwesome" name="book" /><Text style={styles.buttonText}> Book Asset</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.button,{borderColor:'#17AFA0'}]} onPress={this.props.changeMenu.bind(this, 5)}>
