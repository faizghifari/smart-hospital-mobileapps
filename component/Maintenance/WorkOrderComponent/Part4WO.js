...
export default class Part4WO extends Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
      return(
        <ScrollView style={styles.container}>
            {/* display */}
            <Text style={{ fontWeight: 'bold', fontSize: 16, color: 'black', textAlign: 'center', marginBottom: 20 }}>Assesment Details</Text>
            <Form
            ...
            />
            <TouchableHighlight style={styles.button} onPress={this.props.onPress.bind(this, 4)} underlayColor='#99d9f4'>
                <Text style={styles.buttonText}>Next</Text>
            </TouchableHighlight>
            <TouchableHighlight style={[styles.button, {backgroundColor:'#636e70' }]}  onPress={this.props.onBack.bind(this,2)} underlayColor='#99d9f4'>
