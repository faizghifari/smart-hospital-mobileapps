...
export default class Part2Main extends Component {
  constructor(props){
    super(props);
  }
  precautionHandler(index){
    let newPrecaution=this.props.precaution
    newPrecaution[index]=!this.props.precaution[index]
  ...
  specialPrecautions(data,index){
    return(
      <ListItem style={{borderBottomWidth:0}}>
        <CheckBox checked={this.props.precaution[index]} onPress={this.precautionHandler.bind(this,index)} />
        <Body>
    ...
    return(
      <ScrollView style={styles.scrollContainer} contentContainerStyle={styles.scrollContainerContent}>
        <View style={styles.subFormContainer}>
          <Text style={styles.subPartText}>Part 2 - Special Precaution</Text>
          <FlatList
            style={{flex:1}}
            data={precautions}
